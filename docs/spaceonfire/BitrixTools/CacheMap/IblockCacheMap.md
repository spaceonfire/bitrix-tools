...
```php
public static function IblockCacheMap::getInstance(): \spaceonfire\BitrixTools\CacheMap\CacheMap
```

File location: `src/CacheMap/IblockCacheMap.php:23`
...
File location: `src/CacheMap/IblockCacheMap.php:52`
